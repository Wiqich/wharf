...
public class Content implements org.apache.thrift.TBase<Content, Content._Fields>, java.io.Serializable, Cloneable, Comparable<Content> {
  ...
  private static final org.apache.thrift.protocol.TField REL_FIELD_DESC = new org.apache.thrift.protocol.TField("rel", org.apache.thrift.protocol.TType.STRING, (short)1);
  ...
  static {
    ...
    tmpMap.put(_Fields.REL, new org.apache.thrift.meta_data.FieldMetaData("rel", org.apache.thrift.TFieldRequirementType.REQUIRED, 
  ...
  public Content setRel(String rel) {
    this.rel = rel;
    return this;
  }
  ...
  public Content setMd5(String md5) {
    this.md5 = md5;
    return this;
  }
  ...
  public int hashCode() {
    ...
    boolean present_rel = true && (isSetRel());
    list.add(present_rel);
    if (present_rel)
      list.add(rel);
  ...
  public int compareTo(Content other) {
    ...
    lastComparison = Boolean.valueOf(isSetRel()).compareTo(other.isSetRel());
    if (lastComparison != 0) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (rel == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'rel' was not present! Struct: " + toString());
    }
    if (md5 == null) {
